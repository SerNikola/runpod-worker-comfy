...
RUN chmod +x /start.sh /restore_snapshot.sh && \
    ...
    sed -i 's/\r$//' /start.sh /restore_snapshot.sh
...
RUN wget --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/unet/flux1-dev.safetensors https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/flux1-dev.safetensors && \
      ...
      wget -O models/clip/google_t5-v1_1-xxl_encoderonly-fp8_e4m3fn.safetensors https://huggingface.co/mcmonkey/google_t5-v1_1-xxl_encoderonly/resolve/main/t5xxl_fp8_e4m3fn.safetensors && \
      ...
      wget -O models/loras/Eldritch_Comics_for_Flux_1.1.safetensors "https://civitai.com/api/download/models/792184?&token=${CIVITAI_ACCESS_TOKEN}";
